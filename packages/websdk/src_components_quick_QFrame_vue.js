"use strict";
(this["webpackChunk_stechquick_websdk"] = this["webpackChunk_stechquick_websdk"] || []).push([["src_components_quick_QFrame_vue"],{
    ...
    methods: {
        ...
        renderSource: function (url) {
            ...
            if (url.startsWith("data:application/pdf;base64,")) {
                ...
                blob = this.base64ToBlob(takenSrc, "application/pdf");
            }
            else if (this.url.startsWith("data:application/pdf,")) {
                takenSrc = (_b = url.split("data:application/pdf,")) === null || _b === void 0 ? void 0 : _b[1];
                blob = this.base64ToBlob(takenSrc, "application/pdf");
            }
            else if (url.trim().startsWith("<!DOCTYPE html>")) {
                blob = new Blob([url.trim()], { type: 'text/html' });
            }
            else {
                return url;
            }
        ...
        post: function (url, params, enctype) {
            ...
            var frameParent = document.body;
            frameParent.appendChild(form);
            form.submit();
            frameParent.removeChild(form);
        },
        onLoad: function () {
            this.$emit("onLoad");
        }
...
var render = function () {
  ...
  return _c("iframe", {
    ...
    attrs: {
      allow: _vm.allow,
      src: _vm.renderSource(this.url),
      name: this._renderingProps.props().ID + "_qframe",
    },
    on: { load: _vm.onLoad },
  })
}
...
//# sourceMappingURL=src_components_quick_QFrame_vue.js.map?ver=3.1.2-4