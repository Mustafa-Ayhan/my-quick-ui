...
export type ReaderFunction = (data: string, opts: ReaderOptions) => SyncOrAsync<ConversionResult<NodeDocument>>;
export type ShortcutReaderFunction = (data: string, opts: ReaderOptions) => SyncOrAsync<ConversionResult<string>>;
