...
export type WriterFunction = (doc: NodeDocument, opts: WriterOptions) => SyncOrAsync<ConversionResult<string>>;
export type Shortcut = (data: string, writeOpts: WriterOptions, reader: Reader) => SyncOrAsync<ConversionResult<string>>;
