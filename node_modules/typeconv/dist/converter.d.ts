...
export type ConversionResult<T> = ConversionResultInformation & {
    data: T;
};
...
export type ConvertMapFunction = (node: NamedType, index: number, array: ReadonlyArray<NamedType>) => NamedType;
export type ConvertFilterFunction = (node: NamedType, index: number, array: ReadonlyArray<NamedType>) => boolean;
