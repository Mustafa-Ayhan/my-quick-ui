...
export type GenericTypeInfo<T> = Const<T> & Enum<T>;
export interface NodePrimitiveCoreType<Type extends 'any' | 'null' | 'string' | 'number' | 'integer' | 'boolean'> {
    type: Type;
}
export type NodePrimitiveType<Type extends 'any' | 'null' | 'string' | 'number' | 'integer' | 'boolean'> = NodePrimitiveCoreType<Type> & GenericTypeInfo<TypeMap[Type]>;
...
export type PrimitiveType = NullType | StringType | NumberType | IntegerType | BooleanType;
export interface NodeRefCoreType {
    type: 'ref';
    ref: string;
}
export type RefType = NodeRefCoreType & GenericTypeInfo<unknown> & CoreTypeAnnotations;
...
export type ObjectType = NodeObjectCoreType & GenericTypeInfo<object> & CoreTypeAnnotations;
export interface NodeArrayCoreType {
    type: 'array';
    elementType: NodeType;
}
export type ArrayType<T = unknown> = NodeArrayCoreType & GenericTypeInfo<Array<T>> & CoreTypeAnnotations;
...
export type TupleType<T extends unknown[] = unknown[]> = NodeTupleCoreType & GenericTypeInfo<T> & CoreTypeAnnotations;
...
export type NodeWithConstEnum = AnyType | StringType | NumberType | IntegerType | BooleanType | ObjectType | ArrayType | TupleType | RefType;
