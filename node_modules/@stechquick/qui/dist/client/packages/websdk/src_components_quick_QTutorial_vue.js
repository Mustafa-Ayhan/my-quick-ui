"use strict";
(this["webpackChunk_stechquick_websdk"] = this["webpackChunk_stechquick_websdk"] || []).push([["src_components_quick_QTutorial_vue"],{
    ...
    methods: {
        ...
        manupilateDom: function () {
            ...
            this.steps.forEach(function (step, index) {
                var _a;
                var renderingManager = (_a = _this._renderingProps.context()) === null || _a === void 0 ? void 0 : _a.GetItemSingle("RenderingManager"); // :)
                var childComp = renderingManager === null || renderingManager === void 0 ? void 0 : renderingManager.controlDict[step.compID];
                if (!childComp) {
                    console.warn("QTutorial: Could not find component with ID: " + step.compID);
                    return;
                }
                index = index + 1;
                var compDom = childComp === null || childComp === void 0 ? void 0 : childComp.domElement;
                if (!compDom) {
                    return;
                }
...
//# sourceMappingURL=src_components_quick_QTutorial_vue.js.map?ver=3.1.2-4